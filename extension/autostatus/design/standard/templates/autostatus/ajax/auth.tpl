...
<p>
    ...
    {else}
        {'Please click on the following button to authorize autostatus to update your status on %network'|i18n( 'design/admin/workflow/eventtype/edit', '', hash( '%network', $network.name ) )}
